    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/motog.png" alt="image"/></a> </div>
        </div>
...
echo "WELCOME TO MOTOHUB PORTAL";
 } ?>
          </div>
        </div>
      </div>
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
         ...
         <li><a href="contact-us.php">Contact Us</a></li>     <!-- how to comment crtl +/-->
<?php if(isset($_SESSION['login'])) { ?>
    <li><a href="post-vehicle.php">Post Vehicle</a></li>
<?php } ?>
