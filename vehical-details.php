...
if($lastInsertId)
{
echo "<script>alert('booking in process click ok to continue');</script>";
echo "<script type='text/javascript'> document.location = 'my-booking.php'; </script>";
}
else 
{
echo "<script>alert('Something went wrong. Please try again');</script>";
 echo "<script type='text/javascript'> document.location = 'vehicle-listing.php'; </script>";
} }  else{
...
<title>Motohub | Vehicle Details</title>
<!--Bootstrap -->
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <form action="document_upload.php" method="get">
  ...
  <div class="form-group">
   ...
   <input type="hidden" name="vhid" value="<?php echo htmlentities($result->id); ?>">
  <input type="hidden" name="vehicle_id" value="<?php echo $result->id; ?>">
  <input type="hidden" name="vehicle_name" value="<?php echo htmlentities($result->VehiclesTitle); ?>">
  <input type="hidden" name="price" value="<?php echo $result->PricePerDay; ?>">
